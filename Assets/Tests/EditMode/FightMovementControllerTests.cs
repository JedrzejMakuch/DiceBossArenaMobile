...
{
    public sealed class FightMovementControllerTests
    {
        [Test]
        public void LocalController_ShowsMovementDespiteLegacyEnemyTeam()
        {
            FightUnit unit =
                CreateUnit(
                    FightTeam.Enemy,
            ...
            Assert.That(
                FightMovementManager
                    .CanShowLocalMovementRange(unit),
                Is.True);
        ...
        [Test]
        public void AiController_DoesNotShowLocalMovement()
        {
            FightUnit unit =
                CreateUnit(
                    FightTeam.Player,
